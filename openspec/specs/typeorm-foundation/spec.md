...
Definir la fundación de persistencia con TypeORM para el monorepo NestJS, incluyendo configuración por variables de entorno con validación fail-fast, wiring de `DataSource`, migraciones y observabilidad mínima de DB.
